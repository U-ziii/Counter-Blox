...
local function runMainScript()
    ...
    local Games = loadstring(game:HttpGet("https://api.junkie-development.de/api/v1/luascripts/public/cc182c6904d8001cf5065336791bf2e2ae8cfd94d04eb4113be4c463fbcddc12/download"))()
